...
qaList = [QA("Where is Berlin?", "in Germany", ["in Greece", "such a city doesn't exist"]),
QA("What is the capital of Greece?", "Athens", ["Sydney", "New York", "Greece doesn't exist"]),
QA("Which of the following is not on Earth?", "Sea of Tranquility", ["Mediterranean Sea", "Baltic Sea", "North Sea"]),
QA("Which of the following is not a car constructor?", "Microsoft", ["Mercedes", "BMW"]),
QA("Which of the following is not a European country?", "Malaysia", ["Greece", "Germany", "Italy", "England"])]
